...
# gr()
# ENV["GKSwstype"]="nul"
# p1=contourf(z,x,ϕ_1[:,bub_diam,:])
# p2=contourf(z,x,ϕ_2[:,bub_diam,:])
# p3=contourf(z,x,ϕ_3[:,bub_diam,:])
# p4=contourf(z,x,ϕ_4[:,bub_diam,:])
...
# if (me==0) gif(anim, "EW3d_test.gif", fps = 20) end
